...
class EnergyConfig:
    ...
    load_relax_iterations: int = 0
    load_neighbor_repulsion_weight: float = 0.10
    load_relax_max_step_cells: int = 1
    ...
    wind_capacity_min_mw: float = 40.0
    wind_capacity_max_mw: float = 180.0
    pv_capacity_min_mw: float = 25.0
    pv_capacity_max_mw: float = 140.0
